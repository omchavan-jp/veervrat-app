...
const copy = {
  EN: {
    ...
    body: (name: string) =>
      `${name} has accepted your invitation and is now your Vratmitra on Veervrat. You can connect with them from your My Vratmitras page.`,
  },
  MR: {
    subject: 'तुमचे व्रतमित्र आमंत्रण स्वीकारले गेले',
    body: (name: string) =>
      `${name} यांनी तुमचे आमंत्रण स्वीकारले आहे आणि आता ते Veervrat वर तुमचे व्रतमित्र आहेत.`,
  },
};
